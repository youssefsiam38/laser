...
**Last updated:** 2026-09-11T13:13:13Z · orchestrator · HEAD: 7a37677

**Current focus:** T108 durable empties and T112 collapsed counts integrated; Chat/Code routing corrections (T111) precede explicit legacy recovery (T110). Published v0.3.7 and installed processes remain unchanged.
...
| M13 Agents Leap | in-progress | T108/T112 integrated; T111 correcting before review |
...
1. M13-T99: composer draft-restore keystroke-burst crash (retained CDP reproduction).
2. M13-T100: Beam bubble desktop overlap and sticky drawer tooltip.
3. M10-T10: prove the in-app updater installation seam.

## Recently done

- M13-T108: `7a37677`; genuine durable empties, transactional rollback and reconnect-safe questions; 102 focused tests and combined full verify passed.
