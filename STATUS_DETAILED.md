...
| M16-T32 | Streaming touches only the streaming row | in-progress | perf-streaming-3 `01a09c17-bac1-750e-83c5-65039e7a6575` (`agents/perf-streaming-8b9c30fe`) | — | see notes |
...
| M16-T34 | The log store is bounded in bytes and visible | in-progress | orchestrator → worker logstore-budget | — | see notes |
| M16-T35 | The API request modal does not blink while the session streams | in-progress | orchestrator → worker inspector-flicker | — | see notes |
| M16-T36 | Phone dark 2,000-message re-entry meets its budget | todo | — | — | queued to the streaming owner after M16-T32 milestone 2 |
| M16-T37 | The release orchestrator resumes after the tag | in-progress | orchestrator → worker release-resume | — | see notes |
