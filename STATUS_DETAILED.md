...
| Coupled lifecycle | hlc010-admission-owner / `01a08d0a-9a10-70c8-b0d6-ec794e6de23d` | HLC-010 seam; worker lifecycle/driver/server/Chord and related tests only; planning excluded | `120bf303` | refined plan approved; implementation active; exact review includes development merge, patch and all lifecycle changes |
