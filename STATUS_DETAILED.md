...
- Ownership ledger: diagnostics UI · orchestrator `01a0a030` · M18-T3 counter mapping checkpoint integrated `4ba58bd4`; T8 owns PressurePanel plus narrow insertions before final T3 closeout · status in progress.
