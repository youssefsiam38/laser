...
| M16-T17 | Per-project environment command | in-progress | worker workenv (01a09583-df8c-7405-a9c3-6069942b837c, driven by the person) | — | branch `feat/project-environment-command`; machine-setup side is the person's repository |
