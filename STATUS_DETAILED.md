...
- Ownership ledger: renderer session lifetime · completed by `01a0a214-a8d0-76c8-926f-52b824a37031` · integrated `4f34a614` · stable `ViewTailDto`/`installViewTailSink`, `rendererViews`, release, pressure and rehydrate seams handed to T10/T8/T3 · status done.
...
- Ownership ledger: memory-pressure policy · owner `01a0a397-d49e-76c8-926f-532d5ea2d1da` run `run_b186cd2e` · M18-T8 milestone A calibrated thresholds · `/tmp/m18-t8-*` artifacts only · base `722c7ecc` · prerequisite T7 done; source implementation waits T10 · in progress.
