...
| M16-T5 | Playwright: where the browser runs | in-progress | worker playwright-browser-choice (01a094d9-e2a3-7513-89ef-89b0b2a2f4af) | — | root cause of the extension failure: Scrnli extension steals the tab debugger (`/tmp/pwx/REPORT.md`); Laser ships the choice + a page-open Test |
| M16-T6 | Thinking level survives the conversation | in-progress | worker thinking-level-revert (01a094e5-1270-7513-89ef-89c7c9e1b9db) | — | suspect: fallback `engine-port.ts:60` setModel re-derives the level from settings |
...
| M16-T7 | Release 0.5.2 | todo | orchestrator | — | after T5/T6 |
