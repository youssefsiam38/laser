...
- Ownership ledger: transport pressure · `01a0a214-a8cc-76c8-926f-52b4b3d8408e` run `run_31ba15e0` · M18-T7 streaming correctness closeout · same T7 protocol/host/worker/pi-extension tests/evidence paths; packages/relay, T3 pixels, T5/T8/T10/planning excluded · base rebased `36bc51a7`, prior tip `5ae3b06` · next: verify exact bounded scanner/chunker/failure/timer behavior, integrate.
