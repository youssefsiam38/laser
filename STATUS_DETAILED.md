...
- Ownership ledger: worker pressure controller · owner `01a0a397-d49e-76c8-926f-532d5ea2d1da` · current milestone C architecture plan; read worker server/replay/body-range/git/definitions/extension-delivery and protocol contract, write `/tmp/m18-t8-c-plan.md` only; base `23fbf4ae`; prerequisite B done · in progress; next handoff orchestrator plan approval, then same owner implementation.
