...
- Ownership ledger: diagnostics UI · `resource-history-correction` run `run_1a9ad884` fixes audit F1-F3 while RP-4/RP-5/RP-7 produce remaining typed counters · M18-T3 in-progress · next: inspect/integrate correction, then final counter wiring after containment integrations.
