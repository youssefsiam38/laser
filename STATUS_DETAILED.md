...
| M18-T4 | RP-4 bounded worker session lifetime | in-progress | worker-session-lifetime `01a0a1f8-57b0-76c8-926f-52a825867a5f` | — | depends on M18-T2 |
...
- Ownership ledger: worker session lifetime · `01a0a1f8-57b0-76c8-926f-52a825867a5f` run `run_ac95f9f0` · M18-T4 review correction design · original branch paths plus narrow driver seam/focused scratch test; T5/T7/T6 membership/planning excluded · base `551e747` · next: parent approve correction plan, then one fix pass and integration.
