...
| M14-T2 | Worker engine: pinned adapter, store, inspector, sign-in, import, companion module, host routing | todo | — | — | depends on M14-T1 |
| M14-T3 | Settings → MCP servers | todo | — | — | depends on M14-T1 |
| M14-T4 | Transcript: MCP tool rows and image results | todo | — | — | depends on M14-T1; result shapes from the spike (notes) |
