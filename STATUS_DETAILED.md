...
| --- | --- | --- | --- | --- |
| CI repair / release | stabilization-ci (orchestrator) | frozen `ci-035-repair`; unchanged guarded launcher only; no checkout edits | `7a05c79` | independently approved and full verify passed; pushed main; launcher `t-5cbd7e60` awaits exact-SHA CI then verified publication |
