...
- 2026-09-15 implementation started as run `run_e08fe089`: rebase on integrated T6/tracking base `f970a73`, then implement v2.1 and its full-scale calibration/browser matrix without weakening fixtures.
- Ownership ledger: renderer session lifetime · `01a0a214-a8d0-76c8-926f-52b824a37031` run `run_e08fe089` · M18-T5 implementation · UI store/runtime/thread/search, bounded tail DTO and additive T5 calibration/browser script; T4/T6/T7 and planning excluded · base `f970a73` · next: implementation handoff and parent inspection.
