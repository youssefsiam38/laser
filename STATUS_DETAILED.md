...
| M13-T89 | Make pre-turn agent choice tentative until first send | in-progress | claude-2026-09-11-stabilize | — | U1 refusal draft loss and U2 leave/discard corrected together in a UI lane worktree; browser proof and combined-candidate reruns pending; D-191; see notes |
...
| M13-T93 | Serialize child completion, engine settle and resume | in-progress | claude-2026-09-11-stabilize | — | claimed from frozen aca8591 after confirming the previous writer stopped; B1/B2 admission fixes in lane worktree; independent review pending; see notes |
| M13-T94 | Release the next stable patch | in-progress | stabilization-ci | — | publication authorized after original gates plus M13-T98 real-Pi/identified packaged-worker incident acceptance; D-194/D-195; see notes |
...
| M13-T98 | Prevent premature completion and unowned queued continuation | in-progress | claude-2026-09-11-stabilize | — | claimed with M13-T93 under one continuing owner; exact real-Pi two-queued-message regression in lane worktree; packaged-worker gate pending; D-195; see notes |
