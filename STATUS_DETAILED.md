...
- Ownership ledger: memory-pressure policy · `01a0a397-d49e-76c8-926f-532d5ea2d1da` · approved M18-T8 plan, implementation queued · T8 protocol/pressure modules and tests, T4/T5/T6 narrow adapters, spawn helpers, pressure-only Resources subsection; T3 other UI/T7 transport/T10 client excluded · base will be integrated T7 head · prerequisite: T7 done · next: evidence milestone A, then implementation.
...
- Ownership ledger: device tail cache · `01a0a2fe-219e-76c8-926f-52f9c3310b62` · M18-T10 approved plan, waiting · artifact `/tmp/m18-t10-plan.md` v2; future tail-cache/device-storage/client-handshake/desktop-key/settings/migration/tests/docs paths only, no source writes before T5 handoff · plan base `3fb51c7` · prerequisite T5 integration · next: rebase on integrated T5 and implement.
