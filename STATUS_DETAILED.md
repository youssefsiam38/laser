...
| M18-T8 | RP-8 memory-pressure policy and safety ceilings | in-progress | memory-pressure-policy `01a0a397-d49e-76c8-926f-532d5ea2d1da` | B0 calibrated; protocol B through `23fbf4ae`; worker C integrated `a4a364c2` | next: companion D; depends on M18-T4/M18-T5 |
