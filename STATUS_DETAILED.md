...
- Ownership ledger: memory-pressure policy · owner `01a0a397-d49e-76c8-926f-532d5ea2d1da` · current milestone B0+B; permitted protocol inventory/types/tests and narrow host router refusal/tests; base `a575ee85`; prerequisites T16/T18/T11 done · in progress; next handoff independent protocol review.
