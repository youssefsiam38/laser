...
| M16-T25 | The best MCP client there is | in-progress | resume-mcp-discovery `01a099be-556b-7379-b27a-ad3befbb5011` | milestones1–2 merged `c65d3b1`, `7ea56ee`; milestone3 seven checkpoints through `323f3f1`; wire12/earlier MCP170/settings62 pass; `/tmp/mcp-cache-report.md` | `.worktrees/mcp-cache-fe11b683` at5195eec (main9f0044b integrated), clean checkpoint: full verify protocol143/worker789/UI1518, fresh tracked patch22 files, packaged and inspector8-case matrix pass. Discovery gate exposes enabled on-demand cold servers unable to connect after D-230. Same owner assigned narrow internal lazy-connection/guidance correction D-233 then final-byte gates and independent review. Milestone4 dropped; milestone5 outstanding |
