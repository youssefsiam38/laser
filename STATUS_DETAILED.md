...
- Ownership ledger: diagnostics UI · integrated browser gate `a0111f9` · M18-T3 still in-progress only for typed RP-4..RP-7 producers/wiring; next: consume counters after containment integrations, then final retained-state validation.
