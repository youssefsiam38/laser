...
| M16-T29 | Long conversations stay fast after use | in-progress | navigation-selection `01a09911-416f-74c0-9c74-c80b0e35990e` | A `/tmp/sustained-navigation/{REPORT,INTERFACE-PLAN}.md`: source-correlated 2k leave/return 1.66/4.62s, long↔long ~5.9s; duplicate B mount/converter invalidation; zero warm canonical projections; deep anchors lost; live2k switch gap explicit | old owner `01a098ca-d646-74c0-9c74-c7defd720205` stopped and acknowledged no B edits due context exhaustion; inspect confirms ended/no active tools. Preserve private `.worktrees/sustained-navigation-d1e0492b` at `5bcc4fa` and four diagnostic WIP files pending hash-verified cleanup. Transfer B only: adapter stable converter/sidebar selection/tests. C awaits B review/integration and separate authorization |
...
| M16-T25 | The best MCP client there is | in-progress | mcp-cache `01a098ba-15d8-74c0-9c74-c7bcb0a1e085` | milestones 1–2 merged `c65d3b1`, `7ea56ee`; milestone 3 checkpoints `96d68f3`, `2af74fc`, `5a040e1`; `/tmp/mcp-cache-report.md` | `.worktrees/mcp-cache-fe11b683` owns MCP source/patch/tests/inspector/docs, base `cf508f0`; uncommitted cache/revocation work preserved. Prompt contract 20 pass, cache wire 5/6 pending modern fixture schema correction. Same owner resumes fixture-first then remaining auth paths/cache/inspector/gates, followed by independent review. Milestone 4 permanently dropped D-230; milestone 5 outstanding |
