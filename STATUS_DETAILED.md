...
| M15-T6 | Release M15 | in-progress | orchestrator | — | live review done (`/tmp/m15-live/REPORT.md`, 121 screenshots): fallback runtime, file viewer, sidebar states, slash completion, dictation multipart pin and child-notification attribution pass; four UI findings (clipped stopped-run explanation, 28px chain controls on touch, misleading chain copy, empty picker showing a model) fixed at `319ca52`; release next |
