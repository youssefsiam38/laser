...
| M13-T11 | Remove the retired pi-subagents file layer | todo | — | — | depends on M13-T10; D-140 |
| M13-T12 | Keep `.laser` overrides through engine resource reloads | todo | — | — | found by lane W (M13-T3 notes); pre-existing, outside the agents scope |
...
| M13-T21 | Every built-in agent's model is the person's to choose | in-progress | claude-2026-09-08-agents | — | see notes |
| M13-T22 | Namer actually names, and says what an action is doing | in-progress | claude-2026-09-08-agents | — | see notes |
| M13-T23 | A child's transcript opens with the task its parent sent | in-progress | claude-2026-09-08-agents | — | see notes |
| M13-T24 | Sub-sessions fold, and finished ones fold again | in-progress | claude-2026-09-08-agents | — | see notes |
| M13-T25 | Open chat on a run island opens the chat | in-progress | claude-2026-09-08-agents | — | see notes |
| M13-T26 | The panels come out; the fleet becomes a column | in-progress | claude-2026-09-08-agents | — | see notes; D-147 |
| M13-T27 | Re-opening an open session doubles its transcript | in-progress | claude-2026-09-08-agents | — | see notes |
...
| M13-T37 | React #520 on the first prompt of a session (upstream) | blocked | claude-2026-09-09-agents | reproduced on a plain chat, no agents | upstream assistant-ui; see notes |
