...
| M15-T3 | Model fallback chains: settings, runtime, persistence, verification | in-progress | worker fallback-chains (01a091e3-8b36-73a4-a484-ea6b0227d7dd, `agents/fallback-chains-e0b3ad20`) | — | design `docs/model-fallback-chains.md` at `d0f5fe7` approved; phase 2 steps 1/2/5 running, step 3 (`stable-sdk.ts`) waits for the MCP engine merge |
