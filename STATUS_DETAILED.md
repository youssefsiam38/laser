...
| M13-T89 | Make pre-turn agent choice tentative until first send | blocked | draft-agent-selection | — | needs safe same-session backend binding or ownership expansion; D-188; see notes |
...
| M13-T92 | Replace stale Sending state with the queue state | in-progress | pending-delivery | — | D-188; see notes |
| M13-T93 | Serialize child completion, engine settle and resume | in-progress | harness-lifecycle | — | D-188; see notes |
| M13-T94 | Release the next stable patch | todo | — | — | depends on M13-T89–T93; D-188; see notes |
