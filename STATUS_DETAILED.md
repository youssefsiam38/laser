...
| M13-T110 | Explicit legacy-empty draft recovery | todo | — | — | depends T108/T111; see D-211 |
| M13-T111 | Active-tab conversation/send destination isolation | in-progress | tab-destination-isolation | — | see notes; D-212 |
...
| M13-T113 | Release complete current batch as 0.3.8 | todo | orchestrator-release | — | depends remaining T110/T111; D-215 |
...
- Ownership ledger: release0.3.8 · orchestrator-release · pending complete-batch freeze and isolated release preparation · version/generated metadata, release notes and gates; planning parent-only · current main726911e, final base unsettled · T110/T111 incomplete · todo · next: assign isolated prep after source acceptance; exact clean CI before tag, complete assets before publication.
