...
| M18-T16 | RP-5b bounded single-conversation hydration and rendering | in-progress | pinned-view-budget `01a0a430-0193-76c8-926f-5380c13c9ab3` | — | accepted plan `/tmp/m18-pinned-view-plan.md`; depends on M18-T10; blocks M18-T8 renderer gate/M18-T15 |
...
| M18-T18 | RP-4 path-routed mutation authority | todo | — | — | plan `/tmp/m18-t15-session-reopen-plan.md`; added by D-260; blocks M18-T15 |
...
- Ownership ledger: memory-pressure policy · owner `01a0a397-d49e-76c8-926f-532d5ea2d1da` · milestone A evidence complete, branch clean at `722c7ecc`; source milestone B waits T10 protocol-resource handoff and pinned-view decision · in progress.
