...
- Ownership ledger: transport pressure · `01a0a214-a8cc-76c8-926f-52b4b3d8408e` run `run_ee057e49` · M18-T7 parent correction · same T7/protocol/crypto/host/worker/pi-extension/UI tests/evidence paths; packages/relay, T3 pixels, T5/T8/T10/planning excluded · base rebased `36bc51a7`, prior tip `f813651` · next: verify bounded producer/counts/storage and non-regressing footprint, integrate.
