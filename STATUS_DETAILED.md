...
| M16-T29 | Long conversations stay fast after use | in-progress | navigation-selection `01a09911-416f-74c0-9c74-c80b0e35990e` | B `e9c47d9`, `/tmp/sustained-navigation/B-REPORT.md`; full verify/matrices pass; 2k enter 4.62→2.31s, leave 1.66→2.21s; live-growth failure at1240/heartbeat preserved | checkpoint: B complete, owner stopped/clean private tree, all processes exited; coordinator ended redundant profiling and sent exact four-file diff to reviewer `01a09951-5bc6-74c0-9c74-c82441d3bf8e` (`/tmp/review-navigation-selection.md`). One review/fix then integration; C viewport still required, no claim user request done |
...
| M16-T25 | The best MCP client there is | in-progress | mcp-cache `01a098ba-15d8-74c0-9c74-c7bcb0a1e085` | milestones1–2 merged `c65d3b1`, `7ea56ee`; milestone3 seven checkpoints through `323f3f1`; wire12/earlier MCP170/settings62 pass; `/tmp/mcp-cache-report.md` | `.worktrees/mcp-cache-fe11b683` owns MCP source/patch/tests/inspector/docs, base cf508f0. Latest nine-file resolved-target/config-guard correction reopened two status tests (168 pass); directed focused repair, scope frozen, then commit and final fresh-install/browser/package gates, independent review. Preserve WIP. D-230 enforcement mandatory; milestone4 dropped, milestone5 outstanding |
