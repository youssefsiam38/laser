...
| M16-T44 | Review batch: worker | in-progress | worker review-worker | — | see notes |
| M16-T45 | Review batch: host | in-progress | worker review-host | — | see notes |
| M16-T46 | Review batch: relay, crypto, protocol, companion | in-progress | worker review-edge | — | see notes |
| M16-T47 | Review batch: UI runtime, dialogs, PWA | in-progress | worker review-ui-runtime | — | see notes |
| M16-T48 | Review batch: UI components | in-progress | worker review-ui-components | — | see notes |
| M16-T49 | Review batch: desktop | in-progress | worker review-desktop | — | see notes |
