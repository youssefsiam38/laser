...
- Ownership ledger: pressure policy · owner `01a0a397-d49e-76c8-926f-532d5ea2d1da` · milestone C integrated/reviewed; permitted C paths released after `a4a364c2` · status ready for milestone D planning in companion task retention/background work plus the narrow worker measurement seam; prerequisite C done · next handoff: fast-forward owner worktree and approve D plan before code.
