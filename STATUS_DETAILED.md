...
- 2026-09-15 correction design run `run_053bf6e6` started with original owner: settle fail-closed redaction, actor-scoped atomic capture bounds, one exact Noise relay queue/fence, timer-driven stuck detection, exact S9/browser states, exact frame counters, atomic extracted content storage and final-head synthetic evidence before source edits.
- Ownership ledger: transport pressure · `01a0a214-a8cc-76c8-926f-52b4b3d8408e` run `run_053bf6e6` · M18-T7 review correction design · original T7 paths plus narrow crypto shaper API/content-store extraction and tests; packages/relay, T3 pixels/label, T4/T5/planning excluded · base `6890cd7` · next: parent approve correction plan, then one fix pass and integration.
...
- Ownership ledger: memory-pressure policy · `01a0a397-d49e-76c8-926f-532d5ea2d1da` run `run_3e5952b4` · plan-only M18-T8 revision · read-only all relevant T4/T5/T6/T7 seams; no source/planning writes · base `035996e3` · prerequisite for implementation: integrated T7 contract · next: approve v2, continue same owner after T7.
