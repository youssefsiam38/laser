...
| M14-T6 | Live end-to-end proof with Playwright | in-progress | orchestrator (proof by worker mcp-live-proof, fixes by mcp-engine-fixes `agents/mcp-engine-fixes-c146984d` and mcp-settings-fixes `agents/mcp-settings-fixes-6f615649`) | — | see notes: proof run, nine defects, two fix batches in flight; OAuth live UI proof still open |
