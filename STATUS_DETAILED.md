...
| M13-T97 | Release the approved subset as stable 0.3.5 | in-progress | release-preparation | — | user authorized the bounded approved subset; async release gates remain mandatory; D-192; see notes |
