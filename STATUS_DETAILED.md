...
| M15-T4 | Sidebar activity indicators: one indicator, owned by the session itself | in-progress | worker sidebar-and-slash-fixes (01a091e1-c6e5-73a4-a484-ea4576dad59a, `agents/sidebar-and-slash-fixes-84cd3548`) | — | ready at `87c675f`; under review; waits for the M14 tag |
| M15-T5 | Slash completion completes, never sends | in-progress | worker sidebar-and-slash-fixes (same session as T4) | — | ready at `0bd7be9`; under review; waits for the M14 tag |
