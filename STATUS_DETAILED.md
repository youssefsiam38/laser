...
| M13-T89 | Make pre-turn agent choice tentative until first send | in-progress | harness-lifecycle | — | first-binding frozen `a0264674`; continuing integration claimed under D-191; see notes |
| M13-T90 | Align composer controls and recording affordance | in-progress | composer-layout | — | frozen `e7a5b89`; candidate-only gate; D-188; see notes |
| M13-T91 | Show the session’s persisted agent in the header after start | in-progress | header-agent | — | frozen `f174a748`; re-review active; D-188; see notes |
| M13-T92 | Replace stale Sending state with the queue state | in-progress | harness-lifecycle | — | backend `67bf567` integrated; UI hydration frozen in `a0264674`; D-191; see notes |
| M13-T93 | Serialize child completion, engine settle and resume | in-progress | harness-lifecycle | — | focused fix frozen `d79c2869`; continuing integration claimed under D-191; see notes |
| M13-T94 | Release the next stable patch | todo | — | — | preparation candidate only; depends on M13-T89–T93, M13-T95, M13-T96 and explicit permission; D-188–D-191; see notes |
| M13-T95 | Manual aggregate activity open/close persists | in-progress | activity-disclosure | — | approved `131332b` in preparation candidate; D-189; see notes |
| M13-T96 | Blocked terminal runs are neutral finished work | in-progress | neutral-finished-runs | — | approved `d694b07`, not integrated; D-189; see notes |
