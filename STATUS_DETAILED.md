...
- Ownership ledger: release0.3.8 · orchestrator-release · pending complete-batch freeze and isolated release preparation · version/generated metadata, release notes and gates; planning parent-only · final sourcef9a5195 plus freeze ledger · T111 done, T110 dropped · preparing isolated version-only handoff · next: prep0.3.8, single metadata review, exact source CI before tag, verified assets before publication.
