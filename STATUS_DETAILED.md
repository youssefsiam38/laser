...
| M18-T6 | RP-6 bounded task and transcript-delivery lifetime | in-progress | task-delivery-lifetime `01a0a1f8-57b2-76c8-926f-52ac71acb877` | — | depends on M18-T2 |
...
- Ownership ledger: task and delivery lifetime · `01a0a1f8-57b2-76c8-926f-52ac71acb877` run `run_943273e0` · M18-T6 review corrections · same host/task/delivery/protocol/worker/pi-extension/narrow client ownership; adds internal `task-retention.ts`; excludes T4 pool/unload, T5 renderer, T7 decoder/transport/provider queues and planning · base `1e4eeba`, review target `180ee25` · next: verify corrected diff once, integrate, hand stable contracts to T4/T3/T5/T7.
