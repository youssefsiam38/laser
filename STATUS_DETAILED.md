...
| Coupled lifecycle | stabilization-ci preparing handoff | HLC-010 seam; worker lifecycle/driver/server and related tests only | `aba12f7b` + reviewed `7a05c79` | development merge prepared; one new owner will investigate pinned boundary and submit written plan before code |
