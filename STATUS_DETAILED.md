...
| M16-T8 | Every word of the system prompt shows where it came from | in-progress | worker prompt-provenance-ux | — | the person's screenshot: `<inline:lasercode>` labelled "Extension modification", click → "Couldn't open this source file"; a large span "Source not recorded"; sources hidden in a dropdown |
...
| M16-T14 | Worktrees know no stack | in-progress | worker worktree-truth | — | `docs/incidents/worktree-dependencies.md` — the person's principle: every stack, no package-manager knowledge in the harness |
| M16-T12 | Release 0.5.3 | in-progress | orchestrator | — | T9/T10/T11 + inspector fix; T8/T13/T14 → 0.5.4 |
