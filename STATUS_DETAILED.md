...
| M18-T8 | RP-8 memory-pressure policy and safety ceilings | in-progress | memory-pressure-policy `01a0a397-d49e-76c8-926f-532d5ea2d1da` | — | see notes; depends on M18-T4/M18-T5 |
...
- Ownership ledger: memory-pressure policy · owner `01a0a397-d49e-76c8-926f-532d5ea2d1da` · milestone A evidence and final implementation plan complete, branch clean at `722c7ecc`; source milestone B waits T16/T18 integration · in progress.
