...
| M18-T8 | RP-8 memory-pressure policy and safety ceilings | in-progress | memory-pressure-policy `01a0a397-d49e-76c8-926f-532d5ea2d1da` | milestone A `/tmp/m18-t8-calibration.md`; milestone B active at base `a575ee85` | see notes; depends on M18-T4/M18-T5 |
...
- Ownership ledger: memory-pressure policy · owner `01a0a397-d49e-76c8-926f-532d5ea2d1da` · current milestone B contract implementation; permitted protocol inventory/types/tests and narrow host router refusal/tests; base `58b47eba`; prerequisites T16/T18/T11/B0 done · in progress; next handoff independent protocol review.
