...
- Ownership ledger: worker session lifetime · `01a0a1f8-57b0-76c8-926f-52a825867a5f` · M18-T4 waiting after plan · clean worktree base `ad8c188`; future worker/session-safety/host-pool/replay files only, T6 membership and planning files excluded · prerequisite T6 integration · next: rebase on T6 contracts and implement.
