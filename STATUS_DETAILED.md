...
| M14-T3 | Settings → MCP servers | in-progress | worker mcp-settings-fixes (agents/mcp-settings-fixes-6f615649) | merged `763dd52`; UI-fix branch full `pnpm verify`, UI 1197; `/tmp/mcp-settings-fixes-report.md` | live-review defects 2/3/5/7/8/9 fixed; ready for orchestrator review, H-10 |
