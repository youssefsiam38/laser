...
| Coupled lifecycle | hlc010-admission-owner / `01a08d0a-9a10-70c8-b0d6-ec794e6de23d` | HLC-010 seam; worker lifecycle/driver/server/Chord and related tests only; planning excluded | `120bf303` | plan revision requested; patch write scope approved but no code before plan approval; exact review includes development merge |
