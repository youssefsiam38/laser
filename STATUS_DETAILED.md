...
| ID | Task | State | Owner | Evidence | Notes |
| --- | --- | --- | --- | --- | --- |
| M15-T1 | Native file opener: file card and format-aware viewer modal | in-progress | worker file-viewer (see notes) | — | protocol `pi/project/read` added by the orchestrator; worker read service + UI card/viewer assigned; merges after the M14 tag |
