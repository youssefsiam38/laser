...
| M15-T3 | Model fallback chains: settings, runtime, persistence, verification | in-progress | worker fallback-chains (01a091e3-8b36-73a4-a484-ea6b0227d7dd, `agents/fallback-chains-e0b3ad20`) | — | design `docs/model-fallback-chains.md` at `d0f5fe7` approved; phase 2: protocol `95698a9` (84 protocol tests), worker settings `a866601` (27), Settings tab + selector badge `db53d7e` (UI 1122), pure policy/state `32e43aa` (17); the driver controller and the transcript/status projections wait for the MCP engine and transcript merges |
