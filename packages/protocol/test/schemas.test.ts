...
const samples: Record<ClientMethod, unknown> = {
  ...
  "session/new": { cwd: "/p" },
  "session/load": { path: "/s.jsonl", fromSeq: 12, owner: "view" },
  ...
  "session/entry_regions": {
    ...
    revision: "r1.AAAAAAAA.BBBBBBBBBBBBBBBBBBBBBBBBBBB",
    entryId: "entry-1",
    component: { kind: "user_text" as const },
    from: 0,
    limit: 16,
  },
  ...
  "pi/project/file_blob": { cwd: "/p", path: "/s.jsonl", repo: "/p", file: "src/logo.png", ref: "worktree", offset: 0, limit: 524_288 },
  ...
  "pi/project/pr/create": { cwd: "/p", title: "Fix the overlay toolbar", body: "Names the files and the branch.", base: "main", head: "feature/overlay", confirm: true },
  "pi/project/pr/read": { cwd: "/p", number: 12 },
  ...
  "pi/runtime/activation/prepare": { updateId: "a".repeat(64), generationId: "b".repeat(64) },
  "pi/runtime/activation/status": { updateId: "a".repeat(64) },
  "pi/runtime/activation/cancel": { updateId: "a".repeat(64) },
  "pi/worker/activation/park": { updateId: "a".repeat(64), generationId: "b".repeat(64) },
  "pi/worker/activation/status": { updateId: "a".repeat(64) },
  "pi/worker/activation/cancel": { updateId: "a".repeat(64) },
