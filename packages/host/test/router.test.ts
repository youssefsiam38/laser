...
function harness(options: { catalogRows?: SessionSummary[]; open?: Record<string, string[]>; agents?: boolean; workspaces?: { beam: string; chat: string }; exclude?: string[]; now?: () => number; workerRequest?: (method: string, params: unknown) => Promise<unknown>; admission?: PressureAdmission } = {}) {
...
describe("Router · pressure admission", () => {
  ...
  it("refuses a first project worker after project validation and before pool or Namer work", async () => {
