...
beforeEach(()=>{globalThis.IS_REACT_ACT_ENVIRONMENT=true;client.request.mockReset();container=document.createElement("div");document.body.append(container);root=createRoot(container);});
...
it("labels timestamp fallback and excludes captures linked to a different message",async()=>{
  ...
  expect(client.request).toHaveBeenLastCalledWith("pi/logs/query",expect.objectContaining({afterAt:entry.at,beforeAt:"2026-09-06T10:01:00.000Z"}));
});
