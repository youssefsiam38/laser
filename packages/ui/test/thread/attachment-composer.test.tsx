...
import { ConversationAttachmentAdapter } from "../../src/runtime/adapter.js";
...
it("stages a real text file as a named tile and removes it without sending", async () => {
  ...
  function Fixture() {
    runtime = useExternalStoreRuntime({ messages: [], onNew: async () => {}, adapters: { attachments: new ConversationAttachmentAdapter() } });
