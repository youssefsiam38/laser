 ...
 */
const MarkdownTextImpl: FC<MarkdownTextProps> = ({ className, components, nativeFiles = false, sourceBlock }) => {
  ...
  return (
    <SourceBlocks.Provider value={sourceBlock}><NativeFiles.Provider value={nativeFiles}><MarkdownTextPrimitive
    ...
    /></NativeFiles.Provider></SourceBlocks.Provider>
  );
};
