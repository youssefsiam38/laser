              ...
              <li key={item.id}>
                {item.onOpen ? (
                  <button
                    ...
                    onClick={item.onOpen}
                    className={cn(
                      "flex w-full min-w-0 items-start gap-2 rounded-md px-1.5 py-1 text-start outline-none",
                  ...
                  <span className="flex w-full min-w-0 items-start gap-2 px-1.5 py-1">{row}</span>
                )}
              </li>
            );
          })}
