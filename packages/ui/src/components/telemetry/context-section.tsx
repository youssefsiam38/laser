...
const COMPOSITION = [
  ...
  { key: "chat" as const, label: "Chat", tone: "bg-ok" },
  { key: "thinking" as const, label: "Thinking", tone: "bg-attention" },
...
function Composition({ context }: { context: TelemetryContext | undefined }) {
  ...
  return (
    <InstrumentCard className="mt-3">
      ...
      <div className="mt-2 flex h-2 w-full gap-px overflow-hidden rounded-full bg-surface">
