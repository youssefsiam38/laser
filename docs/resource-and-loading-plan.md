...
| RP-8 | M18-T8 | in progress — B0 calibrated D-261; protocol/router B through `23fbf4ae`; reviewed worker-local controller C integrated at `a4a364c2` under D-262/D-263; companion retention D next | RP-4, RP-5 |
