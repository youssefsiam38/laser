...
| RP-8 | M18-T8 | in progress — B0 calibrated D-261; protocol/router B through `23fbf4ae`; reviewed worker controller C at `a4a364c2`; reviewed companion retention D `87e65720`; reviewed host evidence E1 `d8ec6cae` and host pass E2 `55350823`; reviewed renderer pressure F `1b5fbfa7`; reviewed host admission E3 `49cc12d9` and heap ceilings/loss recovery G1–G2 `4f15add0`; packaged and containment proof G3 next | RP-4, RP-5 |
