...
| RP-8 | M18-T8 | in progress — calibrated actor-local policy/ceiling plan `/tmp/m18-t8-final-plan.md`; T16 bounded bodies, T18 route authority and T11 immediate paint are integrated, so source milestone B can start | RP-4, RP-5 |
