...
| RP-8 | M18-T8 | in progress — B0 calibrated D-261; protocol/router B through `23fbf4ae`; reviewed worker controller C at `a4a364c2`; reviewed companion retention D integrated through `87e65720`; host orchestration E planned next | RP-4, RP-5 |
