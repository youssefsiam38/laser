...
| M21-T2 | Stable project identity and canonical store | M21-T1 | transactional project-partitioned store with the personal workspace as an owner and move-into-project (D-352), migrations, integrity, stable repository ids across relocation/worktrees, project removal retention, worktree parent resolution, blobs, bounds and crash tests |
...
| M21-T6 | Embedded workspace shell | M21-T5 | Specs entry, tabs, list/detail/inspector composition, preserved conversation, deep links and every empty/loading/error/stale/offline state at desktop and phone widths |
