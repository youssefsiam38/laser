...
| M18-T14 | RP-14 Electron/Tauri decision gate | After T1–T13 and T15, same UI/host fixtures compare packaged Electron with headless host+PWA; only if shell cost still dominates, a disposable Tauri sidecar spike runs the declared cross-platform functional and footprint matrix against a predeclared benefit, with a recorded keep/migrate decision. |
