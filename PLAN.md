...
This section is the binding product and implementation contract for M21. Its
entity names, ownership rules, revision semantics, gates, surfaces and security
boundaries are decisions, not illustrative suggestions. Implementation tasks
below are the dependency-ordered index.
...
| --- | --- | --- | --- |
| M21-T0 | Binding product contract and dependency plan | M20 person acceptance for implementation, not for planning | this PLAN section and D-329–D-333 settle ownership, storage, nouns, gates, design engine and surfaces; ledger and one-screen status updated |
