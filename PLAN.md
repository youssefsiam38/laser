...
| --- | --- | --- | --- |
| M21-T0 | Binding product contract and dependency plan | M20 person acceptance for implementation, not for planning | the binding specification and D-329–D-333 settle ownership, storage, nouns, gates, design engine and surfaces; ledger and one-screen status updated |
| M21-T1 | Protocol domain, revisions and transition rules | M21-T0 | closed schemas for every primary/supporting record, `ProjectWorkRef`, states, dependency edges, stale propagation and transition tests; no session owner field |
| M21-T2 | Stable project identity and canonical store | M21-T1 | transactional project-partitioned store, migrations, integrity, relocation/relink, project removal retention, worktree parent resolution, blobs, bounds and crash tests |
...
| M21-T7 | Specs and Research experience | M21-T6 | create/edit/revise/archive Specs and Research; brief/full-spec distinction, source/provenance UI, cross-links, search and Markdown reading/editing complete |
...
| M21-T18 | Checkpoints, changes and delivery evidence | M21-T17, M20 | every attempt links M20 base/checkpoints/diffs/commits/PRs, changed files come from git, destructive actions retain previews/confirmations and multiple repositories stay distinct |
...
| M21-T20 | Cross-session continuity and recovery | M21-T9, M21-T17, M21-T18, M21-T19 | create in one session, revise in another, execute in a third, resume after restart/retirement, archive/delete sessions, relocate project and remove worktree with entity identity intact |
| M21-T21 | Import, export and repository publication | M21-T3, M21-T7, M21-T10, M21-T15 | deterministic previewed adapters and manifests, optional project export, explicit conflict handling, provenance/licence retention and no second live authority |
