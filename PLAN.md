...
| M21-T10 | Design-system manifest and adapter contract | M21-T1, M21-T4 | framework-neutral manifest, provenance/conflict model, static source adapters, exact project/profile digests and capability/fidelity reporting; no project execution by default |
...
| M21-T12 | Native validation runner and source selection | M21-T10, M21-T11 | isolated actual-framework preview, explicit trust, provider/fixture support, semantic node/source bridge, Native evidence and normal unsupported/degraded states; desktop and remote frame paths |
| M21-T13 | Design workspace and anchored review | M21-T8, M21-T11, M21-T12 | Audit/Foundation/Flows/Screens/Review path, canvas controls, inspector, comments, before/after revisions, fidelity labels and all applicable state matrices in both themes and widths |
