...
| M16-T29 | Long conversations stay fast after use | depends on M16-T16 and M16-T24; repeated short↔long and long↔long switches remain responsive after paging to old history and after a session grows live; bound mounted transcript work independently of loaded history without deleting canonical data; preserve reading position, drafts, focus, disclosures, approvals, find, versions and original-entry actions; compare before/after browser median and p95 at 40, 240 and 2,000 loaded messages, including outgoing unmount and incoming commit; desktop/phone, both themes; implementation design approved from a measured reproduction (D-231) |
