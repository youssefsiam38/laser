...
Dependencies: M16-T16, M16-T21, M16-T22, M16-T29, M16-T30 and M16-T31 are done. Tasks below follow the RP dependency graph in `docs/resource-and-loading-plan.md`; RP numbers are preserved as task suffixes.
...
| M18-T2 | RP-2 controlled reproduction and heap attribution | Credential-free scratch/browser scenarios cover 50 sessions, long paging/streaming/images, 10 children/200 commands, projects, hide/restore, slow consumers and detach/retire; reports separate retained heap/native/shared/peaks with repeatable owner rankings and pre/post-GC evidence. |
